        ...
        <Row>
          ...
          <Col xs={"12"} md={"6"}>
              ...
              <p className="texts-justify  text-blue bold-text">
                ...
                nacido en la clase social baja. Aquí la educación es una de las
                pocas herramientas que pueden sacar adelante a una familia. Para
                un niño nepalí y su familia, sentir el apoyo de gente que ni
                siquiera los conoce, pero que confían en ellos y que les importa
                su futuro, es un regalo tremendo, el que cada una de estas
                familias se ha comprometido personalmente a no desaprovechar.
                Además, se presentó la oportunidad concreta con esta comunidad
                de generar un puente de trabajo confiable y sostenible para el
                apoyo de manera responsable, y el seguimiento que corresponde a
                cada uno de estos niños y sus familias.
              </p>
              </div>
          </Col>
        </Row>
